...
class GreenMarketAddView extends StatefulWidget {
  GreenMarketAddView({Key key, this.topicID}) : super(key: key);
                ...
                Container(
                  ...
                  child: DropdownButton<String>(
                    ...
                    icon: Icon(
                      ...
                      color: Color(0xFF0C7805),
                    ),
                    iconSize: 24,
                    elevation: 16,
                    style: TextStyle(color: Color(0xFF40b103)),
                    underline: Container(
                      height: 1,
