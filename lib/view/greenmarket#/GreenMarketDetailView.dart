...
class _GreenMarketDetailViewState extends State<GreenMarketDetailView> {
  ...
  Future<List<AllList>> postNewsDetail(
    ...
    setState(() {
      ...
      shopLine = data['shopLine'].toString();
                  ...
                  if (shopTime != "")
                    Container(
                      ...
                      child: Row(
                        children: [
                          Image.asset(
                            'assets/images/market/clock.png',
                            width: 10,
                          ),
                          Expanded(
                            child: Container(
                  ...
                  if (shopPhone != "")
                    Container(
                      ...
                      child: Row(
                        children: [
                          Image.asset(
                            'assets/images/market/phone.png',
                            width: 10,
                          ),
                          Expanded(
                            child: Container(
