...
class MarketFavListView extends StatefulWidget {
  @override
  _MarketFavListViewState createState() => _MarketFavListViewState();
}

class _MarketFavListViewState extends State<MarketFavListView> {
  var data = [];
  List<String> arrFav = [];
