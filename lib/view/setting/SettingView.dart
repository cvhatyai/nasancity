...
import 'package:nasancity/view/menu/MenuView.dart';
...
class _SettingViewState extends State<SettingView> {
  ...
  updateData() async {
    if (isSwitched) {
      user.isNoti = "1";
      firebaseMessaging.subscribeToTopic("th.go.nasancity");
      firebaseMessaging.subscribeToTopic("news");
    } else {
      user.isNoti = "";
      firebaseMessaging.unsubscribeFromTopic("th.go.nasancity");
