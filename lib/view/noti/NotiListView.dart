...
import 'package:nasancity/view/complain/ComplainAdminDetailView.dart';
...
class _NotiListViewState extends State<NotiListView> {
  ...
  gotoDetail(fnName, topicID) {
    ...
    } else if (fnName == "garbageDetail" || fnName == "garbageAdmin") {
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => WebPageView(
    ...
    } else if (fnName == "taxDetail" || fnName == "taxAdmin") {
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => WebPageView(
